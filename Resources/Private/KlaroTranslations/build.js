...
const klaroTranslationsDir = path.join(
  __dirname,
  "../../../node_modules/klaro/src/translations"
);
...
const xlfTranslationsDir = path.join(__dirname, "../../Private/Translations");
const xlfName = "Klaro";
``;
