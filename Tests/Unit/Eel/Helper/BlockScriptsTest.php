...
class BlockScriptsTest extends UnitTestCase
{
    public function scriptTagsWillBeBlockedWithoutConfig()
    {
        ...
        $actual = $cookiePunch->blockScripts($markup);
    ...
    public function markedTagsWillNeverBeBlocked()
    {
        ...
        $markup = '<script src="myscripts.js"></script>';
        $actualWithDataAttribute = $cookiePunch->neverBlockScripts(
            $markup
        );
        $actualNotBlocked = $cookiePunch->neverBlockScripts(
        ...
        $actualWithDataAttribute = $cookiePunch->neverBlockIframes(
            $markup
        );
        $actualNotBlocked = $cookiePunch->neverBlockIframes(
            $actualWithDataAttribute
        );
    ...
    public function tagsWillUseServiceNameFromEelHelperAndNotSettings()
    {
        ...
        $actual = $cookiePunch->blockScripts(
            $markup,
            true,
            "foo"
        );
